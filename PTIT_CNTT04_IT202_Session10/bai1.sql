...
-- tao 1 view có tên view_users_firstname để hiển thị danh sách các người dùng có họ “Nguyễn”. View này cần bao gồm các cột: user_id, username, full_name, email, created_at.
...
insert into users(username, full_name, gender, email, password, birthdate, hometown) values
("Loc_dz","Nguyễn Duc Loc","Nam","loc@gmail.com",'123','2006-05-25',"Vinh Phuc");

-- Thực hiện xóa nhân viên vừa thêm khỏi bảng Users.
delete from users where username = "Loc_dz"; 
